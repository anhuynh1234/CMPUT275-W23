...
public:
  ...
  // find last item
  ListNode<T>* findLastItem(const T& item) const;
  ...
  void removeAllButOne(const T& item);
  void reverse();
...
template <typename T>
ListNode<T>* LinkedList<T>::findLastItem(const T& item) const{
...
template <typename T>
void LinkedList<T>::removeAllButOne(const T& item){
